define("Contacts_MiniPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.Input",
					"multiline": false,
					"label": "$Resources.Strings.StringAttribute_hf1fdrh",
					"labelPosition": "above",
					"control": "$StringAttribute_hf1fdrh",
					"visible": true,
					"placeholder": "#ResourceString(GivenName_placeholder)#",
					"tooltip": ""
				},
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.Input",
					"multiline": false,
					"label": "$Resources.Strings.StringAttribute_fb0b8ey",
					"labelPosition": "above",
					"control": "$StringAttribute_fb0b8ey",
					"visible": true,
					"placeholder": "#ResourceString(Surname_placeholder)#",
					"tooltip": ""
				},
				"parentName": "MainContainer",
				"propertyName": "items",
			...
			{
				"operation": "insert",
				"name": "addRecord_gll1jw0",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_gll1jw0_caption)#",
					"clicked": {
		...
		viewModelConfig: /**SCHEMA_VIEW_MODEL_CONFIG*/{
			"attributes": {
				"StringAttribute_hf1fdrh": {
					"modelConfig": {
						"path": "ContactDS.GivenName"
					}
				},
				"StringAttribute_fb0b8ey": {
					"modelConfig": {
