define("Accounts_FormPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "addRecord_1ij4pe8",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_1ij4pe8_caption)#",
					"clicked": {
						"request": "crt.CreateRecordFromLookupRequest",
						"params": {}
					}
			...
			{
				"operation": "insert",
				"name": "addRecord_a8dkqhj",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_a8dkqhj_caption)#",
					"clicked": {
						"request": "crt.CreateRecordFromLookupRequest",
						"params": {}
					}
			...
			},
			{
				...
				"values": {
					...
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_y9dz5pc_caption)#",
					"clicked": {
						"request": "crt.CreateRecordFromLookupRequest",
						"params": {}
					}
			...
			{
				"operation": "insert",
				"name": "PrimaryContactFieldFlexContainer",
				"values": {
					"layoutConfig": {
						"column": 1,
						"row": 2,
			...
			},
			{
				...
				"parentName": "PrimaryContactFieldFlexContainer",
				"propertyName": "items",
				"index": 0
			},
			{
			...
			{
				"operation": "insert",
				"name": "addRecord_63m4h0d",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_63m4h0d_caption)#",
					"clicked": {
						"request": "crt.CreateRecordFromLookupRequest",
						"params": {}
					}
				},
				"parentName": "Ownership",
				"propertyName": "listActions",
				"index": 0
			},
			{
			...
			{
				"operation": "insert",
				"name": "addRecord_t0qvc6k",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_t0qvc6k_caption)#",
					"clicked": {
						"request": "crt.CreateRecordFromLookupRequest",
						"params": {}
					}
				},
				"parentName": "AnnualRevenue",
				"propertyName": "listActions",
				"index": 0
			},
			{
			...
			{
				"operation": "insert",
				"name": "addRecord_hbs4000",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_hbs4000_caption)#",
					"clicked": {
						"request": "crt.CreateRecordFromLookupRequest",
						"params": {}
					}
		...
		modelConfig: /**SCHEMA_MODEL_CONFIG*/{
			"dataSources": {
				...
				"AccountCommunicationOptionsItemsDS": {
					"type": "crt.EntityDataSource",
					"scope": "viewElement",
					"config": {
